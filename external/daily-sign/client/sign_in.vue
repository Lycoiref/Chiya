      ...
      <div class="content">
        ...
        <div class="avater-warpper">
          ...
          <div>
            <img
              ...
              :src="query.user_avatar + '&spec=' + query.spec"
        ...
        <div v-if="avatarLoaded" id="avatar-ok" class="text-content">
          <div class="text-info">
            ...
            <div class="text-tittle">好感度等级 0</div>
            <div class="text-tittle">
              上次签到时间：{{
                query.checkin_time_last_str
                  ? query.checkin_time_last_str
                  : "未知"
              }}
            </div>
          ...
          <div class="text-dayshow">
            <div class="text-dayshow-big">今日签到</div>
            <div class="text-tittle">
            ...
            <div class="text-tittle">金币 + 114514</div>
            <div class="text-tittle">连续签到 114514 天</div>
          </div>
        </div>
      </div>
    </div>
...
onBeforeMount(async () => {
  // 获取图片高度
  const res = await axios.get("/daily-sign");
  const imgString = res.data;
  console.log(imgString);
  signBackground.value = imgString.attrs.url;
});
</script>
